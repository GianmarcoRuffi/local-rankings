...
CREATE INDEX "idx_username_attempts" ON "login_attempts" USING btree ("username");--> statement-breakpoint
CREATE INDEX "idx_locked_until" ON "login_attempts" USING btree ("locked_until");--> statement-breakpoint
